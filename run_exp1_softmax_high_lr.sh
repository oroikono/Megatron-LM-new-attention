#!/bin/bash
#SBATCH --job-name=exp1-softmax-high-lr
...
#SBATCH --output=/iopsstor/scratch/cscs/ooikonomou/Megatron-LM-new-attention-wt/logs/exp1-softmax-high-lr-%j.out
#SBATCH --error=/iopsstor/scratch/cscs/ooikonomou/Megatron-LM-new-attention-wt/logs/exp1-softmax-high-lr-%j.err

echo "===== EXPERIMENT 1: SOFTMAX + HIGH LR (NO WARMUP) ====="
echo "Purpose: Test stability - softmax should struggle without warmup"
...
CKPT_DIR=$MEGATRON_DIR/checkpoints/exp1-softmax-high-lr
LOG_DIR=$MEGATRON_DIR/logs/exp1-softmax-high-lr-$SLURM_JOB_ID
...
echo "===== DONE: Exp1 Softmax High LR ====="
