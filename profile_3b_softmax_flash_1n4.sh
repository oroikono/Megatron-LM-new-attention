#!/bin/bash
#SBATCH --job-name=profile-3b-softmax-flash-1n4
...
#SBATCH --output=/iopsstor/scratch/cscs/ooikonomou/Megatron-LM-new-attention/logs/profile-3b-softmax-flash-1n4-%j.out
#SBATCH --error=/iopsstor/scratch/cscs/ooikonomou/Megatron-LM-new-attention/logs/profile-3b-softmax-flash-1n4-%j.err

echo "===== PROFILE: 3B SOFTMAX+FLASH (1N4G) ====="
...
LOG_DIR=$MEGATRON_DIR/logs/profile-3b-softmax-flash-1n4-$SLURM_JOB_ID
NSYS_OUT=$LOG_DIR/nsight-softmax-flash
mkdir -p $LOG_DIR
...
echo "===== DONE: PROFILE SOFTMAX+FLASH ====="
