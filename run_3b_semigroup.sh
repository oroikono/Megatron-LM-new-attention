...
#SBATCH --output=/iopsstor/scratch/cscs/ooikonomou/Megatron-LM-new-attention/logs/3b-semigroup-%j.out
#SBATCH --error=/iopsstor/scratch/cscs/ooikonomou/Megatron-LM-new-attention/logs/3b-semigroup-%j.err

echo "===== 3B SEMIGROUP ATTENTION ====="
...
LOG_DIR=$MEGATRON_DIR/logs/3b-semigroup-$SLURM_JOB_ID
